        ...
        <div class="row">
            <form action="{{ action('Admin\TodoController@index') }}" method="get">
                ...
                <div class="my-4">
                    ...
                    <a href="{{ action('Admin\TodoController@complete_list') }}" role="button" class="btn btn-primary mx-2">完了タスク</a>
                    <a href="{{ action('Admin\TodoController@dead_list') }}" role="button" class="btn btn-primary mx-2">期限切れタスク</a>
                </div>
            </form>
        </div>
        <div class="row">
